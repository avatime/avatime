...
insert into avatar (image_path, name) values ("mask/action.jpg", "액션가면"),
("mask/hulk.jpg", "헐크"),
("mask/jocker.jpg", "조커"),
("mask/genie.jpg", "지니"),
("mask/babyjk.jpg", "아기조커"),
("mask/hamster.png", "햄찌우먼"),
("mask/watermelon.png", "수박맨"),
("mask/pinejm.png", "파인잼민"),
("mask/pattrick.png", "뚱이"),
("mask/alien.png", "알린"),
("mask/bonobono.png", "보노보노"),
("mask/bear.png", "갈매기곰"),
("mask/battery.png", "건전지"),
("mask/kiyoung.png", "기영이"),
("mask/stone.png", "꼬마돌"),
("mask/pig.png", "부리부리"),
("mask/army.png", "위장크림"),
("mask/ghost.png", "토시오"),
