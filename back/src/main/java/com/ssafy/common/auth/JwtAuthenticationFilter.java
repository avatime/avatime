...
public class JwtAuthenticationFilter extends BasicAuthenticationFilter {
    ...
    public Authentication getAuthentication(HttpServletRequest request) throws Exception {
        ...
        if (token != null) {
            ...
            // Search in the DB if we find the user by token subject (name)
            ...
            if (name != null) {
                ...
                if(user != null) {
                		...
                		UsernamePasswordAuthenticationToken jwtAuthentication = new UsernamePasswordAuthenticationToken(name,
